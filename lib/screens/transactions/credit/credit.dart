...
import 'package:dooid/screens/transactions/credit/creditSuccess.dart';
...
class Credit extends StatefulWidget {
  ...
  const Credit({Key? key, required this.foundContact}) : super(key: key);
          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                ...
                onChanged: (value) {
                  setState(() {
                    _validatePhoneNumber = value.length < 7;
                  });
                },
              ),
            ),
